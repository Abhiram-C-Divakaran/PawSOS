    ...
    try:
        ...
        if not vet_facility_a:
            vet_facility_a = VeterinaryFacility(
                ...
                latitude=18.9215,
                longitude=72.8335,
                location="POINT(72.8335 18.9215)",
        ...
        if not vet_facility_b:
            vet_facility_b = VeterinaryFacility(
                ...
                latitude=19.1180,
                longitude=72.8450,
                location="POINT(72.8450 19.1180)",
        ...
        profile1 = RescuerProfile(
            ...
            latitude=18.9220,
            longitude=72.8340,
            current_location="POINT(72.8340 18.9220)",
        ...
        profile2 = RescuerProfile(
            ...
            latitude=18.9250,
            longitude=72.8370,
            current_location="POINT(72.8370 18.9250)",
            service_radius_km=15.0,
            vehicle_available=True,
        ...
        profile3 = RescuerProfile(
            ...
            latitude=18.9950,
            longitude=72.8250,
            current_location="POINT(72.8250 18.9950)",
            service_radius_km=15.0,
            vehicle_available=True,
            experience_level="Expert",
            last_location_update=datetime.utcnow(),
        ...
        profile_b = RescuerProfile(
            ...
            latitude=19.1197,
            longitude=72.8464,
            current_location="POINT(72.8464 19.1197)",
            service_radius_km=15.0,
            vehicle_available=True,
            experience_level="Expert",
            last_location_update=datetime.utcnow(),
        ...
        case_org_b = RescueCase(
            ...
            latitude=19.1197,
            longitude=72.8464,
            location="POINT(72.8464 19.1197)",
        ...
        case_concurrent = RescueCase(
            ...
            latitude=18.9220,
            longitude=72.8347,
            location="POINT(72.8347 18.9220)",
